...
<html lang="<?php echo $language; ?>">
    ...
    <head>
        ...
        <meta property="og:image"
            content="<?php echo $protocol; ?>://www.<?php echo $site_url; ?>/static/meta-img/facebook-preview.jpg" />
        ...
        <meta name="twitter:image"
            content="<?php echo $protocol; ?>://www.<?php echo $site_url; ?>/static/meta-img/twitter-preview.jpg">
        ...
        <link rel="apple-touch-startup-image"
            href="<?php echo $protocol; ?>://www.<?php echo $site_url; ?>/static/meta-img/apple-touch-startup-image-320x460.png"
            media="(device-width: 320px) and (device-height: 480px) and (-webkit-device-pixel-ratio: 1)">
        <link rel="apple-touch-startup-image"
            href="<?php echo $protocol; ?>://www.<?php echo $site_url; ?>/static/meta-img/apple-touch-startup-image-640x920.png"
            media="(device-width: 320px) and (device-height: 480px) and (-webkit-device-pixel-ratio: 2)">
        <link rel="apple-touch-startup-image"
            href="<?php echo $protocol; ?>://www.<?php echo $site_url; ?>/static/meta-img/apple-touch-startup-image-640x1096.png"
            media="(device-width: 320px) and (device-height: 568px) and (-webkit-device-pixel-ratio: 2)">
        <link rel="apple-touch-startup-image"
            href="<?php echo $protocol; ?>://www.<?php echo $site_url; ?>/static/meta-img/apple-touch-startup-image-768x1004.png"
            media="(device-width: 768px) and (device-height: 1024px) and (orientation: portrait) and (-webkit-device-pixel-ratio: 1)">
        <link rel="apple-touch-startup-image"
            href="<?php echo $protocol; ?>://www.<?php echo $site_url; ?>/static/meta-img/apple-touch-startup-image-1024x768.png"
            media="(device-width: 768px) and (device-height: 1024px) and (orientation: landscape) and (-webkit-device-pixel-ratio: 1)">
        <link rel="apple-touch-startup-image"
            href="<?php echo $protocol; ?>://www.<?php echo $site_url; ?>/static/meta-img/apple-touch-startup-image-1536x2008.png"
            media="(device-width: 768px) and (device-height: 1024px) and (orientation: portrait) and (-webkit-device-pixel-ratio: 2)">
        <link rel="apple-touch-startup-image"
            href="<?php echo $protocol; ?>://www.<?php echo $site_url; ?>/static/meta-img/apple-touch-startup-image-2048x1496.png"
